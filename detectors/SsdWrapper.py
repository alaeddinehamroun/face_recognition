...
def build_model():
    ...
    # model structure
    if not os.path.isfile(home + '/.facerecognition/weights/deploy.prototxt'):
        print("deploy.prototxt will be downloaded...")
        url = "https://github.com/opencv/opencv/raw/3.4.0/samples/dnn/face_detector/deploy.prototxt"
        output = home + '/.facerecognition/weights/deploy.prototxt'
        gdown.download(url, output, quiet=False)

    # pre-trained weights
    if not os.path.isfile(home + '/.facerecognition/weights/res10_300x300_ssd_iter_140000.caffemodel'):
        ...
        output = home + '/.facerecognition/weights/res10_300x300_ssd_iter_140000.caffemodel'
